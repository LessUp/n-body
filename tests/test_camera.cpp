...
TEST(ColorMapperTest, VelocityToColor) {
  ...
  EXPECT_GE(color_low.r, 0.0f);
  EXPECT_LE(color_low.r, 1.0f);
  EXPECT_GE(color_low.g, 0.0f);
  EXPECT_LE(color_low.g, 1.0f);
  EXPECT_GE(color_low.b, 0.0f);
  EXPECT_LE(color_low.b, 1.0f);

  EXPECT_GE(color_high.r, 0.0f);
  EXPECT_LE(color_high.r, 1.0f);
  EXPECT_GE(color_high.g, 0.0f);
  EXPECT_LE(color_high.g, 1.0f);
  EXPECT_GE(color_high.b, 0.0f);
  EXPECT_LE(color_high.b, 1.0f);
